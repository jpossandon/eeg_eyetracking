function eeg_subject_stats(cfg, EDF_name, event_name)  
...
event                           = read_event([cfg.eegfolder event_name]);
starts                          = [event(2).sample:cfg.artifact_chunks_length:event(end).sample]';
