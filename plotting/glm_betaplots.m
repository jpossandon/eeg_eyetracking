function glm_betaplots(cfg_eeg,stimB,result,interval,pathfig,coeffs)
% GLM result plots
...
%     fh = plot_stat(cfg_eeg,result.clusters(b),betas,[],interval,collim,.05,sprintf('Beta:%s',coeffs{b}),1);
%     doimage(fh,pathfig,'png',[ datestr(now,'ddmmyy')  '_sign_glm_' model '__' coeffs{b}],1)
%     
